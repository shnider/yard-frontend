...
import compleximg1 from '../images/compleximg1.jpg'
import compleximg2 from '../images/compleximg2.jpg'
import compleximg3 from '../images/compleximg3.jpg'
...
export default () =>
  (<BodyClassName className="complexes">
    <div>
      ...
      <Cards>
        <Grid>
          <Card id={1} location="SOUTH BEACH, SAN FRANCISCO" name="764 Metropolitan Avenue" imgSrc={compleximg1}>
          ...
          <Card id={2} location="MIDTOWN EAST, MANHATTAN" name="100 East 53rd Street" imgSrc={compleximg2}>
          ...
          <Card id={3} location="NOLITA, MANHATTAN" name="152 Elizabeth" imgSrc={compleximg3}>
